...
public class MarketApplication {
	static final Logger log =
			LoggerFactory.getLogger(MarketApplication.class);
	...
	public CommandLineRunner commandLineRunner
		...
		return args -> {
			...
			/*Categories categories = categoriesService.save(
					new Categories(null, "Смартфоны",
						Files.readAllBytes(Path.of("D:\\rolll\\IdeaProjects\\OnlineMarket\\assets\\Mask group.png"))
					)
			);
			...
			products.get(1).getImage().add(imageService.save(
					new Image(new File("D:\\rolll\\IdeaProjects\\OnlineMarket\\assets\\samsung-galaxy-s23.png"))));
			products.get(2).getImage().add(imageService.save(
					new Image(new File("D:\\rolll\\IdeaProjects\\OnlineMarket\\assets\\iphone-14.png"))));
			products.get(0).getImage().add(imageService.save(
					new Image(new File("D:\\rolll\\IdeaProjects\\OnlineMarket\\assets\\nothing-2.png"))));
			...
			Promotion promotion = new Promotion(null, Files.readAllBytes(Path.of("D:\\rolll\\IdeaProjects\\OnlineMarket\\assets\\promo-cover_L.png")), "Скидки на флагманские смартфоны",
					"Не пропусти недели флагманских смартфонов в GLANCES " +
							"Покупай топовые модели брендов с Супервыгодой — выбирай уже сейчас на сайте, в приложении и в магазинах сети.",
